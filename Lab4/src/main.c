...
#include "lwip/err.h"
#include "lwip/sys.h"
#include "D:\AI_1B\Rafael\Laborator2\mdns\include\mdns.h"
...
void start_mdns_service()
{
    ...
    mdns_instance_name_set("Rafael thing");
}
...
void app_main(void)
{
    ...
    if (connected) {
        // Initialize mDNS and query for devices
        start_mdns_service();
        resolve_mdns_host("esp32-Rafael");
    } else {
